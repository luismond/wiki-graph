...
from __init__ import (
    MODEL, SIM_THRESHOLD, LANG_CODES, SEED_PAGE_NAME, HEADERS, logger,
    current_datetime_str
    )
from db_util import (
    insert_paragraph, get_paragraph_embeddings, get_paragraph_corpus,
    get_paragraphs_by_page_id, get_pages_data, insert_page_metadata,
    read_autonyms_data, get_unsaved_autonym_page_ids, insert_autonym,
    get_page_links_page_ids, insert_page_link, get_page_links_data
    )
